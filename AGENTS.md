...
**Protocol**: 1. Identify domain → 2. Read agent file in `.Codex/agents/` → 3. Load skills from agent frontmatter → 4. Follow agent's workflow.

| Priority | Location                                                | Content                            |
| -------- | ------------------------------------------------------- | ---------------------------------- |
| 1        | `.Codex/agents/`, `.Codex/commands/`                  | Project-specific agents & commands |
...
- **Параллельные сессии**: Writer/Reviewer паттерн — один Codex пишет, другой ревьюит.
