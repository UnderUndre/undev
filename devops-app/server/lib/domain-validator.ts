/**
 * Feature 008 T012 — server-side domain validator (FR-030).
 *
 * Single source of truth for domain validity. Mirrored byte-for-byte by
 * `client/lib/domain-validator.ts` (T013); parity is asserted in T014.
 *
